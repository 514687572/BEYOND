...
class HtmlCoreReport extends HtmlAbstractReport {
	...
	private static class HtmlForms extends HtmlAbstractReport {
		...
		private void writeDeploymentPeriodDiv(Map<String, Date> datesByWebappVersions,
			...
			final String startDateLabel = I18N.getString("startDate").toLowerCase(
	...
	void toHtml(String message, String anchorNameForRedirect) throws IOException {
		...
		writeSummary();
		writeln("</h3>");
		write("<a href='https://yg669.com'>");
		writeln("<img class='noPrint' style='position: absolute; top: 15px; right: 10px; border: 0;' width='100' height='40' src='?resource=donate.gif' alt='与果网' /></a>");
	...
	private void writeSummary() throws IOException {
		final String javaMelodyUrl = " STIP Monitoring ";
